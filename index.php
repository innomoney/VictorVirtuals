...
include "./validate/index.inc.php";
...
<!-- Mirrored from iamubaidah.com/html/miscoo/live/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jan 2023 09:06:07 GMT -->
<head>
            ...
            <div class="row justify-content-center">
                <div class="col-xl-8 col-lg-8 col-sm-8">
                    <div class="banner-txt">
                        <h4>tuska is a long profeting</h4>
            ...
            <div class="row justify-content-xl-between justify-content-lg-between justify-content-sm-center">
                <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
                    <div class="part-txt">
                        ...
                        <p>Lorem ipsum dolor sit, amet consectetur adipis icing elit. Distinctio architecto nobis totam odio aliquam repellat quam rem harum alias animi ducimus quibusdam, sint placeat <span>"omnis dolores odit ipsum ut autem! quam rem harum alias animi ducimus quibusdam, sint placeat omnis dolores odit ipsum ut autem!"</span></p>
                    </div>
                </div>
                ...
                <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
                    <div class="part-txt right">
                        ...
                        <p>Lorem ipsum dolor sit, amet consectetur adipis icing elit. Distinctio architecto nobis totam odio aliquam repellat quam rem harum alias animi ducimus quibusdam, sint placeat omnis dolores odit ipsum ut autem! quam rem harum alias animi ducimus quibusdam, sint placeat omnis dolores odit ipsum ut autem!</p>
        ...
        <div class="container">
            <div class="row justify-content-xl-end justify-content-lg-end justify-content-sm-center">
                <div class="col-xl-5 col-lg-6 col-sm-10 col-md-7 d-xl-flex d-lg-flex d-block align-items-center">
                    <div class="part-text">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi iusto, fuga consequuntur laudantium porro suscipit minima, delectus commodi possimus animi nesciunt neque hic fugiat. Alias sequi consectetur voluptate voluptatum quaerat.</p>
                        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Aperiam reprehenderit molestiae in, illo similique.</p>
                        <a href="#0" class="def-btn">play now</a>
                    </div>
                </div>
                <div class="col-xl-4 col-lg-5 col-sm-10 col-md-5 offset-xl-1 offset-lg-1 offset-0">
                    <div class="part-img">
                        <img src="assets/img/iq-img.jpg" alt="">
            ...
            <div class="part-features">
                <div class="row justify-content-sm-center justify-content-md-start">
                    <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
                        <div class="single-feature">
                            <img class="icon" src="assets/img/svg/money-exchange.svg" alt="">
                    ...
                    <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
                        <div class="single-feature">
                            <img class="icon" src="assets/img/svg/analytics.svg" alt="">
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-6">
                                    <div class="single-activity">
                                        ...
                                        <div class="part-text">
                                            <p><span class="player-name">Mukta</span> won 2 minutes ago<br/> on game of <a href="#0" class="game-name">Mega Matrix</a></p>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-6">
                                    <div class="single-activity">
                                        ...
                                        <div class="part-text">
                                            <p><span class="player-name">Shehwar</span> won 2 minutes ago<br/> on game of <a href="#0" class="game-name">Royal Casino</a></p>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-6">
                                    <div class="single-activity">
                                        ...
                                        <div class="part-text">
                                            <p><span class="player-name">Maria</span> won 2 minutes ago<br/> on game of <a href="#0" class="game-name">Poker Club</a></p>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-6">
                                    <div class="single-activity">
                                        ...
                                        <div class="part-text">
                                            <p><span class="player-name">Drubo</span> won 2 minutes ago<br/> on game of <a href="#0" class="game-name">Slots 375</a></p>
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-6">
                                    <div class="single-activity">
                                        ...
                                        <div class="part-text">
                                            ...
                                            <p>Player ID: <span class="player-name">Mukta</span> <br/> Game: <a href="#0" class="game-name">Jackpot Club</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-6">
                                    <div class="single-activity">
                                        ...
                                        <div class="part-text">
                                            ...
                                            <p>Player ID: <span class="player-name">Sraddha</span> <br/> Game: <a href="#0" class="game-name">Jackpot Club</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-6">
                                    <div class="single-activity">
                                        ...
                                        <div class="part-text">
                                            ...
                                            <p>Player ID: <span class="player-name">Anushka</span> <br/> Game: <a href="#0" class="game-name">Jackpot Club</a></p>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-xl-12 col-lg-12 col-md-6">
                                    <div class="single-activity">
                                        ...
                                        <div class="part-text">
                                            ...
                                            <p>Player ID: <span class="player-name">Genelia</span> <br/> Game: <a href="#0" class="game-name">Jackpot Club</a></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-xl-12 col-lg-12 col-md-6">
                                    <div class="single-activity">
                                        ...
                                        <div class="part-text">
                                            <p>Name: <span class="player-name">Mukta Martin</span> <br/> Game: <a href="#0" class="game-name">Mega Matrix</a></p>
            ...
            <div class="row justify-content-xl-between justify-content-lg-between justify-content-sm-center justify-content-md-start">
                <div class="col-xl-5 col-lg-6 col-md-9 col-sm-10 d-xl-flex d-lg-flex d-block align-items-center">
                    <div class="part-text">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Officia minima animi fugit qui, tenetur laudantium a sint at aliquam.</p>
                        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi fugit qui, tenetur laudantium a sint at aliquam mollitia.</p>
                    ...
                    <div class="col-xl-6 col-lg-6 col-sm-10 col-md-6">
                        <div class="part-form">
                            <form method="post" action="">
                                <input type="text" name="username" placeholder="Players Name">
                                <input type="text" name="email" placeholder="Players Email">
                                <textarea name="message" placeholder="Write to Us..."></textarea>
                                <button class="submit-btn def-btn" name="submit" type="submit">Submit</button>
                            </form>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-4 col-sm-10 col-md-6">
...
<!-- Mirrored from iamubaidah.com/html/miscoo/live/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jan 2023 09:12:06 GMT -->
</html>