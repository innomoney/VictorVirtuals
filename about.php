...
include "./validate/about.inc.php";
...
<!-- Mirrored from iamubaidah.com/html/miscoo/live/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jan 2023 09:13:15 GMT -->
<head>
            ...
            <div class="container">
                <div class="row justify-content-xl-end justify-content-lg-end justify-content-sm-center">
                    <div class="col-xl-6 col-lg-6 col-sm-10 col-md-12 d-xl-flex d-lg-flex d-block align-items-center">
                        <div>
                            <div class="part-text">
                                <h2>We Discover The Best <br/>Blockchain & CryptoGaming</h2>
                                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi iusto, fuga consequuntur laudantium porro suscipit minima, delectus commodi possimus animi nesciunt neque hic fugiat. Alias sequi consectetur voluptate voluptatum quaerat. ipsum dolor sit amet consectetur.</p>
                                ...
                                <div class="row">
                                    <div class="col-xl-4 col-lg-4 col-sm-4">
                                        <div class="single-statics">
                                            <div class="part-icon">
                                                <img src="assets/img/svg/virtual-reality.png" alt="">
                                            </div>
                                            <div class="part-text">
                                                <span class="statics-count">
                                                    1.5k
                                                </span>
                                                <span class="statics-title">
                                                    Users
                                                </span>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-sm-4">
                                        <div class="single-statics">
                                            <div class="part-icon">
                                                <img src="assets/img/svg/poker-cards.png" alt="">
                                            </div>
                                            <div class="part-text">
                                                <span class="statics-count">
                                                    500+
                                    ...
                                    <div class="col-xl-4 col-lg-4 col-sm-4">
                                        <div class="single-statics">
                                            <div class="part-icon">
                                                <img src="assets/img/svg/globe.png" alt="">
                                            </div>
                                            <div class="part-text">
                                                <span class="statics-count">
                                                    102+
                    ...
                    <div class="col-xl-5 col-lg-5 col-sm-10 col-md-12 offset-xl-1 offset-lg-1 offset-0">
                        <div class="part-img">
                ...
                <div class="row justify-content-center">
                    <div class="col-xl-6 col-lg-7 col-sm-10">
                        <div class="section-title style-2">
                            <h2>We Are CryptoGaming Exparts</h2>
                            <p>Misco has thousands of free online games for all generation. Play action, racing, sports, and other fun games for free at Misco</p>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-xl-3 col-lg-3 col-sm-6 team-1">
                        <div class="single-member">
                            <div class="part-img">
                                <img src="assets/img/team/member-1.png" alt="">
                            </div>
                            <div class="part-text">
                                <span class="name">Sohure Danyel</span>
                                <span class="position">CEO & Head</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-3 col-lg-3 col-sm-6 team-2">
                        <div class="single-member">
                            <div class="part-img">
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6 team-3">
                        <div class="single-member">
                            <div class="part-img">
                    ...
                    <div class="col-xl-3 col-lg-3 col-sm-6 team-4">
                        <div class="single-member">
                            <div class="part-img">
...
<!-- Mirrored from iamubaidah.com/html/miscoo/live/about.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jan 2023 09:13:32 GMT -->
</html>        