...
<!-- Mirrored from iamubaidah.com/html/miscoo/live/games.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 14 Jan 2023 09:13:32 GMT -->
<head>
                            ...
                            <div class="filtering">
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        ...
                                        <a class="dropdown-item" href="#">Intellectual</a>
                                        <a class="dropdown-item" href="#">Online Casino</a>
                                        <a class="dropdown-item" href="#">Lottery Draw</a>
                                        <a class="dropdown-item" href="#">Chess Master</a>
                                    </div>
                                </div>
                            </div>
                            <div class="filtering">
                    ...
                    <div class="col-xl-9 col-lg-9 col-md-8">
                        <div class="all-games anim-change">
                            <div class="title-cover">
                                <h4 class="games-title"><span class="icon icon-1"></span> All Games</h4>
                            </div>
                        ...
                        <div class="all-games anim-change">
                            <div class="title-cover">
                                <h4 class="games-title"><span class="icon icon-8"></span> New Release</h4>
                            </div>
                            <div class="row miscoo-row">
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="single-game">
                        ...
                        <div class="all-games anim-change">
                            <div class="title-cover">
                                <h4 class="games-title"><span class="icon icon-9"></span> Most Popular</h4>
                            </div>
                            <div class="row miscoo-row">
                                <div class="col-xl-3 col-lg-4 col-sm-6">
                                    <div class="single-game">
